...
console.log('languages aray', languages);
// log method of console object is being called with two arguments
...
// languages takes the index equivalent to the variable 'lastIndex'
// lastIndex equates to the length of the whole array minus 1
